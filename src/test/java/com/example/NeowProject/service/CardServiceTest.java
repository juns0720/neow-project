...
class CardServiceTest {
    ...
    void findCardsByCardType() {
        ...
        assertEquals(cardService.findCardsByCardType(CardType.POWER).size(), 2);
    ...
    void findCardsByColor() {
        Card card1 = createCard("박치기", Color.RED, 2, CardType.ATTACK, Rarity.COMMON);
        Card card2 = createCard("던지기", Color.BLACK, 2, CardType.POWER, Rarity.COMMON);
        Card card3 = createCard("잡기", Color.RED, 2, CardType.POWER, Rarity.COMMON);
        ...
        assertEquals(cardService.findCardsByColor(Color.BLACK).size(), 1);
        assertEquals(cardService.findCardsByColor(Color.RED).size(), 2);
    }
